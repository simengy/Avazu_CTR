...
# A, paths
train = 'train_copy.csv'               # path to training file
test = 'test_copy.csv'                 # path to testing file
submission = 'submission_plus_trial4.csv'  # path of to be outputted submission file

# B, model
alpha = 0.40  # learning rate
beta = 1.2   # smoothing parameter for adaptive learning rate
L1 = 0.7     # L1 regularization, larger value means more regularized
L2 = 0.7     # L2 regularization, larger value means more regularized
